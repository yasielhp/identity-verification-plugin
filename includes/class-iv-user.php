    ...
    public function verification_form_shortcode() {
        ...
        if ($verification_status === 'verified') {
            ...
            <div class="box-status verified">
                <h3 class="box-status-title verified">' . __('Verified', 'identity-verification') . '</h3>
                <p class="box-status-description verified">' . __('Your identity has been successfully verified. Thank you for helping to maintain a safe environment.', 'identity-verification') . '</p>
                <a class="button" href="/">' . __('Access', 'identity-verification') . '</a>
            </div>';
        }
        ...
        if ($verification_status === 'pending') {
            ...
            <div class="box-status process">
                <h3 class="box-status-title process">' . __('In Process', 'identity-verification') . '</h3>
                <p class="box-status-description process">' . __('Your identity verification is in process. This process will be completed within 24 hours during business hours.', 'identity-verification') . '</p>
            </div>';
        }
